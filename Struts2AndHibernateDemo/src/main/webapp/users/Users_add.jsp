...
<div id="navi">
    <div id='naviDiv'>
        ...
        <span><img src="../images/arror.gif" width="7" height="11" border="0" alt=""></span>&nbsp;添加用户
    </div>
</div>
<div id="main" align="center">
    <!-- 从session中获取学生集合 -->
    <br/>
    <h2 align="center">修改用户资料</h2>
    <br>
    <hr style="width: 500px;margin: auto;border: 1px solid darkturquoise;"/>
    <br>

    <form name="addForm" action="<%=path%>/users/Users_addUser.action" method="post" onsubmit="return chenk()">
        <table id="mytable">
            <tr>
                <td>用&nbsp;户&nbsp;名：</td>
            ...
            <tr>
                <td colspan="2" align="center"><input id="button" type="submit" value="添加">
                </td>
            </tr>
        </table>
    </form>
