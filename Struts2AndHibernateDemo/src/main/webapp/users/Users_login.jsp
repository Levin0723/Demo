...
.btn{
    ...
    text-shadow: 0 1px 1px #F6F6F6;
    background-image: -moz-linear-gradient(left top, #D9D9D9, #A6A6A6 49%, #A6A6A6 50%);
...
<div id="wrapper">
		...
		<div id="mainBg">
			<div id="mainPanel">
				...
				<div id="right">
					...
					<div>
					  <span style="color: red"><s:fielderror/></span> <!-- 显示表单验证的出错信息 -->
					</div>
					<!-- end of form -->
					</form>
				</div>
	...
	<div id="footer">
		<div id="text">Copyright © 2009-2017 All Rights Reserved Powered By Simoniu</div>
	</div>
</div>
</body>
</html>