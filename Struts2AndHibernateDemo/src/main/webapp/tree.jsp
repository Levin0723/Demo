...
var treeMenu = [
	{ level:1, name:"学生管理"},
	{ level:2, name:"学生列表", ico:"images/icon_default.gif",link:"students/Students_queryAllStudnets.action"},
	{ level:1, name:"用户管理"},
	{ level:2, name:"用户列表", ico:"images/icon_default.gif",link:"users/Users_queryAllUsers.action"},
	{ level:1, name:"信息管理"},
	{ level:2, name:"新闻管理", ico:"images/icon_default.gif",link:"default.jsp"},
	{ level:2, name:"公告管理", ico:"images/icon_default.gif",link:"default.jsp"},
	{ level:1, name:"系统邮件", ico:"images/icon_default.gif",link:"default.jsp"},
	{ level:1, name:"网络文件", ico:"images/icon_default.gif",link:"default.jsp"}
];
</script>
<style>
* {
