...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="<%=path%>/resources/js/back/list.js"type="text/javascript"></script>
	</head>
	<body style="background: #e1e9eb;">
		<form action="List.action" id="mainForm" method="post">
			<div class="right">
				<div class="current">当前位置：<a href="javascript:void(0)" style="color:#6E6E6E;">内容管理</a> &gt; <a href="List.action">内容列表</a></div>
				<div class="rightCont">
					<p class="g_title fix">内容列表 <a class="btn03" href="#">新 增</a>&nbsp;&nbsp;&nbsp;&nbsp;
						<a class="btn03" href="javascript:deleteBatch();" onclick="return confirm('确定要删除多条指令吗？')">删 除</a></p>
					<table class="tab1">
						<tbody>
							<tr>
					...
					<div class="zixun fix">
						<table class="tab2" width="100%">
							<tbody>
								<tr>
								    <th><input type="checkbox" id="all" onclick="javascript:choseAll()"/></th>
								    <th>序号</th>
								    <th>指令</th>
								    <th>描述</th>
								    <th>操作</th>
								...
								<tr <c:if test="${status.index %2 != 0}">style="background-color:#ECF6EE;</c:if>">
									...
									<td>
										<a href="#">修改</a>&nbsp;&nbsp;&nbsp;
										<a href="deleteOne.action?id=${message.id}" onclick="return confirm('确定要删除该指令 么？')">删除</a>
									</td>
								</tr>
								</c:forEach>
							</tbody>
